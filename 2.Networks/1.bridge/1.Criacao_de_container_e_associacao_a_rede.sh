...
printf "docker run -it --rm --network-alias container_1 --name container_1 -h container_1 --network lab_network mcbacker/ubuntu:lab bash\n\n"

docker run -it --rm --network-alias container_1 --name container_1 --hostname container_1 --network lab_network mcbacker/ubuntu:lab bash