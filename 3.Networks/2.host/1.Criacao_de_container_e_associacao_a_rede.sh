...
printf "docker run -it --rm --name container_1 --hostname container_1 --network host rrvieira/ubuntu:1.0 bash \n\n"

docker run -it --rm --name container_1 -h container_1 --network host rrvieira/ubuntu:1.0 bash